...
VALUES
  ...
  ('CE/DR','DevOps Engineer',2,2,'jun 2019 - aug 2019','I containerized a Meteor/MongoDB application, configured Red Hat Enterprise Linux servers, and deployed the application using Docker Swarm. I also added an Nginx service to proxy requests and provide TLS/SSL support.'),
  ('CIC Websites','Full Stack Developer',2,2,'dec 2018 - jun 2019','I merged 9 applications (database, backend, and frontend) into one, enabling a smoother deployment process while cutting down hosting costs. I added new features, pushed them to production, and moved the application to the ibm.com domain.'),
  ...
  ('EA VAT','Front End Developer',2,2,'dec 2017 - dec 2017','For IBM, I was involved in the development of a tool that clients and consultants can use to assess the value of enterprise applications.'),
  ...
  ('Apple-style Microsite','Front End Developer',2,2,'jul 2017 - aug 2017','To impress an important potential client for IBM, I created a beautiful Apple-style microsite.'),
  ...
  ('Biometry Law Evaluation','Student-Researcher (graduation project)',1,1,'jun 2016 - jan 2017','For an official law evaluation, I wrote a Python application to analyze if Dutch government agencies acted in compliance with the law when collecting biometric data from foreigners.');
