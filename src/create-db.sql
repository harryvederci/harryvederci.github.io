...
VALUES
  ...
  ('CE/DR','DevOps Engineer','IBM CIC Benelux','Groningen',null,null,'I containerized a Meteor/MongoDB application, configured Red Hat Enterprise Linux servers, and deployed the application using Docker Swarm. I also added an Nginx service to proxy requests and provide TLS/SSL support.','jun 2019 - aug 2019'),
  ('CIC Websites','Full Stack Developer','IBM CIC Benelux','Groningen',null,null,'I merged 9 applications (database, backend, and frontend) into one, enabling a smoother deployment process while cutting down hosting costs. I added new features, pushed them to production, and moved the application to the ibm.com domain.','dec 2018 - jun 2019'),
  ('PoR Microservices','Backend Developer','IBM CIC Benelux','Groningen',null,null,'I was involved in the creation of several Java microservices for an award winning Port of Rotterdam enterprise IoT application. My team independently designed solutions and took care of the DevOps process.','apr 2018 - dec 2018'),
  ('PoR GUI','Front End Developer','IBM CIC Benelux','Groningen',null,null,'I improved the quality, structure and development workflow of an enterprise IoT application for Port of Rotterdam. I did this by unit testing and refactoring existing code, adding new features, and reviewing the code of other developers. I also added a test validation script to ensure reviewers that new code will not break existing features.','jan 2018 - apr 2018'),
  ('EA VAT','Front End Developer','IBM CIC Benelux','Groningen',null,null,'For IBM, I was involved in the development of a tool that clients and consultants can use to assess the value of enterprise applications.','dec 2017 - dec 2017'),
  ('SportInnovator','Full Stack Developer','IBM CIC Benelux','Groningen',null,null,'I added new features to a government-owned Ruby on Rails application about innovation in sports. I deployed changes to production myself.','jul 2017 - dec 2017'),
  ('PoR PoC','Front End Developer','IBM CIC Benelux','Groningen',null,null,'As a Proof of Concept, I created the front end of an application that visualises data collected by sensors in the Port of Rotterdam. The Proof of Concept was a success, and was followed up by a big enterprise project spanning multiple years.','aug 2017 - jul 2017'),
  ('Apple-style Microsite','Front End Developer','IBM CIC Benelux','Groningen',null,null,'To impress an important potential client for IBM, I created a beautiful Apple-style microsite.','jul 2017 - aug 2017'),
  ('Watson Bank','Front End Developer','IBM CIC Benelux','Groningen',null,null,'For a major German bank, I went to Frankfurt to create the front end of an IBM Watson application. With a rapidly approaching deadline, I made creative solutions to overcome the limitations of a very restricted developing environment.','jun 2017 - jul 2017'),
